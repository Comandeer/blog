...
{% include 'figure' src="../../../images/tik-tak/devtools.png" alt="Zakładka Network w narzędziach developerskich Chrome'a: wszystkie trzy żądania po obrazki w usłudze Slowfil.es są oznaczone jako anulowane." %}
