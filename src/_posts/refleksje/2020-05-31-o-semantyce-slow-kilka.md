...
{% figure "../../images/o-semantyce-slow-kilka/accessibility-tree.png" "Element h1 ma rolę heading, podczas gdy span – text container." "Widok elementów w inspektorze dostępności Firefoksa" %}
...
{% figure "../../images/o-semantyce-slow-kilka/google-schema.png" "Moja książka w wynikach wyszukiwania ma ocenę 4.2/6 w Helionie oraz 6/10 w Lubimy czytać." %}
