...
{% figure "../../images/jednoplikowe-komponenty-fetch.png" "Konsola Google Chrome wyświetlająca informacje o wczytaniu pliku HelloWorld.wc, a następnie wyświetlająca jego zawartość w formie tekstu" %}
...
{% figure "../../images/jednoplikowe-komponenty-parsowanie.png" "Konsola Chrome pokazująca sparsowane drzewko DOM komponentu" %}
...
{% figure "../../images/jednoplikowe-komponenty-dzialanie1.png" "Komponent wyświetlony w Chrome: czerwony prostokąt o zaookrąglonych krawędziach, wewnątrz którego znajduje się napis: &quot;Hello, world! My name is Comandeer.&quot;" %}
...
{% figure "../../images/jednoplikowe-komponenty-dzialanie2.png" "Komunikat wyświetlony w Chrome po naciśnięciu komponentu:  &quot;Don't touch me!&quot;" %}
