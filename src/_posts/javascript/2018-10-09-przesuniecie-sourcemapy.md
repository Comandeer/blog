...
{% include 'figure' src="../../images/przesuniecie-sourcemapy/example1.jpg" alt="Otwarta zakładka &quot;Sources&quot; w devtools Google Chrome pokazująca przerobiony kod oraz drzewko wyboru plików po lewej, zawierającc zarówno plik output.js, jak i input.js" %}
...
{% include 'figure' src="../../images/przesuniecie-sourcemapy/example1-console.jpg" alt="Konsola wyświetlająca wynik stworzenia nowego obiektu klasy Test, pokazująca, że wywołanie console.log nastąpiło w 4 linii pliku input.js" %}
