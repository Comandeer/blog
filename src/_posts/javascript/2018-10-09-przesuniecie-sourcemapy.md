...
{% note %}`Int16Array` to jedna z tzw. [<i lang="en">Typed Arrays</i> (Typowanych Tablic)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray). Ten szczegół dla nas jest całkowicie nieistotny, bo tablica ta zachowuje się praktycznie tak samo jak normalna.{% endnote %}
...
{% figure "../../images/przesuniecie-sourcemapy/example1.jpg" "Otwarta zakładka &quot;Sources&quot; w devtools Google Chrome pokazująca przerobiony kod oraz drzewko wyboru plików po lewej, zawierającc zarówno plik output.js, jak i input.js" %}
...
{% figure "../../images/przesuniecie-sourcemapy/example1-console.jpg" "Konsola wyświetlająca wynik stworzenia nowego obiektu klasy Test, pokazująca, że wywołanie console.log nastąpiło w 4 linii pliku input.js" %}
