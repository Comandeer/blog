...
{% note %}Bardzo często spinnery są wyświetlane w `stderr` (czyli strumieniu przeznaczonym na błędy). Jest to związane z niepisaną konwencją, według której [wszystkie diagnostyczne rzeczy powinny trafiać właśnie tam](https://web.archive.org/web/20201111211140/https://www.jstorimer.com/blogs/workingwithcode/7766119-when-to-use-stderr-instead-of-stdout).{% endnote %}
